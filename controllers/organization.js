...
const { loginService, resgisterOrgService, createTeamService,
    ...
    getAllNoties, createInternalNoticeService, removeNoticeService } = require('../services/organization')
...
module.exports.addEmployeeData = async (req, res, next) => {
    ...
    try {
        ...
        // }
        await addEmployeeDataService(firstname, lastname, email, phone_number, gender, birthdate, role, teamid, password)//file, 
